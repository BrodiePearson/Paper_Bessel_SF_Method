...
ylim([ymin, ymax]);
xlim([xmin, xmax]);
legend([Energy_Flux Bessel_SFveladv_Flux SFuadv_Flux],'Actual Flux','Bessel Method: SF_{Au}', ...
...
ylabel('Spectral Flux (m^2 s^{-3})')
legend([Enstrophy_Flux Bessel_SFbadv_Flux SFbadv_Flux],'Actual Flux','Bessel Method: SF_{Ab}', ...
