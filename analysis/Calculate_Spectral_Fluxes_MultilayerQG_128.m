...
start_file = 16; %Time = 40 or 2/mu which is when the simulation equilibrates
end_file = 38;

%experiment_name = "multilayerqg_2layer_" + nx + "_beta_" + beta ;
%experiment_name = "multilayerqg_2layer_" + nx + "_beta_" + beta + "_Ld_0.70";
...
save("./processed_data/Spectral_Fluxes_" + experiment_name +".mat",'-struct','Spectral_Flux','-v7.3');
...
%% Plot energetic evolution of the simulation

figure
plot(kinetic_energy(1,:), 'k')
hold on
plot(kinetic_energy(2,:), 'r')
