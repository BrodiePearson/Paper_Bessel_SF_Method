...
forcing_rate = "1.0e-5";
endtime = "30000.0";
%beta = "0.0"; % Switch beta off for some simulations where it is zero
...
for dir_no = 1:size(direction,2)
    ...
    save("Structure_Functions_" + experiment_name +"_"+ direction(dir_no) +".mat",'-struct','Structure_Function','-v7.3');
