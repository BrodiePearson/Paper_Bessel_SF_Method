...
% No beta (NB)
experiment = ["SB","WB","NB"]; %["SB","SBd","WB","WBd","NB"];
betay = ["10.0", "1.0", "0.0"]; %["10.0", "7.071067811865475", "1.0", "0.7071067811865475", "0.0"];
betax = ["0.0", "0.0", "0.0"]; %["0.0", "7.071067811865475", "0.0", "0.7071067811865475", "0.0"];
