...
b = [-1.0, -1.2]           # the buoyancy of each layer
...
filename = filepath*"/multilayerqg_2layer_"*string(n)*".jld2"
matfilename = filepath*"/multilayerqg_2layer_"*string(n)
nothing # hide
