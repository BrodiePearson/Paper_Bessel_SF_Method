...
stepper = "FilteredRK4"  # timestepper
     dt = 0.02           # timestep [0.02]
 nsteps = 300000           # total number of time-steps [300000]
...
# We choose folder for outputing `.jld2` files and snapshots (`.png` files).
datapath = "./simulations/Output/Data/Spin-up/"
plotpath = "./simulations/Output/Figures/Spin-up/"
plotname = "snapshots"
...
anim = @animate for j=0:Int(nsteps/nsubs)
  ...
  if j%(100/nsubs)==0;  write_matlab_file(matfilename, vs, gr, cl.t, diags) end
